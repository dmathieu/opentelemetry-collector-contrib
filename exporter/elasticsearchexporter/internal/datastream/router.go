...
var (
	...
	RouteLogRecord = routeWithDefaults(defaultTypeLogs)
	...
	// This function may mutate record attributes.
	RouteSpanEvent = routeWithDefaults(defaultTypeLogs)
)
...
func routeWithDefaults(defaultDSType string) func(
	...
	return func(
		...
		dataset, datasetExists := getFromAttributes(DatasetKey, defaultDataset, recordAttr, scopeAttr, resourceAttr)
		namespace, namespaceExists := getFromAttributes(NamespaceKey, defaultNamespace, recordAttr, scopeAttr, resourceAttr)
		...
		recordAttr.PutStr(DatasetKey, dataset)
		recordAttr.PutStr(NamespaceKey, namespace)
		recordAttr.PutStr(TypeKey, defaultDSType)
